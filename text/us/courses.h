COURSE_ACTS(COURSE_BOB, _(" 1 REX CLIFFSIDE"),
...
COURSE_ACTS(COURSE_WF, _(" 2 CREEPY CRAWLY CORRIDOR"),
...
COURSE_ACTS(COURSE_JRB, _(" 3 MISTIC JUNGLE"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 FREEZING RABBIT-HOLE"),
...
COURSE_ACTS(COURSE_BBH, _(" 5 SINISTER CURSED CRYPT"),
...
COURSE_ACTS(COURSE_HMC, _(" 6 SHIFTING POOL MAZE"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 BIG WHALE'S BELLY"),
...
COURSE_ACTS(COURSE_SSL, _(" 8 SHINY STARRY SKY"),
...
COURSE_ACTS(COURSE_DDD, _(" 9 WET, DRY DOCKS"),
...
COURSE_ACTS(COURSE_SL, _("10 SNOWMAN'S INFERNO"),
...
COURSE_ACTS(COURSE_WDW, _("11 DRY, DRY DESERT"),
...
COURSE_ACTS(COURSE_TTM, _("12 YOSHI'S RAINBOW MOUNTAIN"),
...
COURSE_ACTS(COURSE_THI, _("13 CLOUDY FLOATING TOWN"),
...
COURSE_ACTS(COURSE_TTC, _("14 INTERNAL SUBWAY RAILROADS"),
...
COURSE_ACTS(COURSE_RR, _("15 YOU SHOULDN'T BE HERE"),
       _("???")  , _("THE BIG HOUSE IN THE SKY")      , _("COINS AMASSED IN A MAZE"),
       _("SWINGIN' IN THE BREEZE")        , _("TRICKY TRIANGLES!")             , _("SOMEWHERE OVER THE RAINBOW"))

SECRET_STAR(COURSE_BITDW, _("   PLEXUS"))
SECRET_STAR(COURSE_BITFS, _("   PLEXUS"))
SECRET_STAR(COURSE_BITS, _("   ???"))
SECRET_STAR(COURSE_PSS, _("   PLEXUS"))
SECRET_STAR(COURSE_COTMC, _("   PLEXUS"))
SECRET_STAR(COURSE_TOTWC, _("   PLEXUS"))
SECRET_STAR(COURSE_VCUTM, _("   PLEEXUS"))
SECRET_STAR(COURSE_WMOTR, _("   PLEXUS"))
SECRET_STAR(COURSE_SA, _("   PLEXUS"))
SECRET_STAR(COURSE_CAKE_END, _(""))

CASTLE_SECRET_STARS(_("   PLEXUS STARS"))

EXTRA_TEXT(0, _("ONE OF THE PLEXUS STARS!"))
EXTRA_TEXT(1, _(""))
EXTRA_TEXT(2, _(""))
EXTRA_TEXT(3, _(""))
EXTRA_TEXT(4, _(""))
